...
const userSchema = new Schema(
  {
    ...
    country: { type: String, enum: ["IN", "US", "CA", "GB", "AU"], default: "IN", index: true },
    currency: { type: String, enum: ["INR", "USD", "CAD", "GBP", "AUD"], default: "INR" },
    dialCode: { type: String, enum: ["+91", "+1", "+44", "+61"], default: "+91" },
...
const studioSchema = new Schema(
  {
    ...
    settings: {
      ...
      country: { type: String, enum: ["IN", "US", "CA", "GB", "AU"], default: "IN" },
...
const subscriptionSchema = new Schema(
  {
    ...
    purchaseToken: { type: String, sparse: true, unique: true, select: false },
    originalTransactionId: String,
    country: { type: String, enum: ["IN", "US", "CA", "GB", "AU"], default: "IN", index: true },
    currency: { type: String, enum: ["INR", "USD", "CAD", "GBP", "AUD"], default: "INR", index: true },
    priceAmountMicros: { type: Number, min: 0 },
    ...
    storeProducts: [
      {
        ...
        active: { type: Boolean, default: true },
        countries: [{ type: String, enum: ["IN", "US", "CA", "GB", "AU"] }],
      },
    ],
...
const subscriptionEventSchema = new Schema(
  {
    ...
    country: { type: String, enum: ["IN", "US", "CA", "GB", "AU"], index: true },
    currency: { type: String, enum: ["INR", "USD", "CAD", "GBP", "AUD"], index: true },
    priceAmountMicros: { type: Number, min: 0 },
...
const appConfigSchema = new Schema(
  {
    ...
    supportedCountries: [{
      code: { type: String, enum: ["IN", "US", "CA", "GB", "AU"] },
      active: { type: Boolean, default: true },
      subscriptionsVisible: { type: Boolean, default: true },
    }],
  },
  base,
);
